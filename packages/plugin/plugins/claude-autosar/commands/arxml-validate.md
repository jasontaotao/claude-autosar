...
name: arxml-validate
description: |
  ARXML 文件校验（lxml + XSD schema）。底层调用 `claude-autosar arxml validate`。
  用法：`/claude-autosar:arxml-validate <path-to-arxml> [--xsd <path-to-xsd>]`
allowed-tools: Bash
---

# /claude-autosar:arxml-validate
...
```
/claude-autosar:arxml-validate <path-to-arxml>
/claude-autosar:arxml-validate <path-to-arxml> --xsd <path-to-xsd>
/claude-autosar:arxml-validate <path-to-arxml> --strict
```
...
```
/claude-autosar:arxml-validate Mcu.arxml
/claude-autosar:arxml-validate EcuExtract.arxml --xsd AUTOSAR_00046.xsd
/claude-autosar:arxml-validate Bswmd_Can.arxml --strict --show-line
```
